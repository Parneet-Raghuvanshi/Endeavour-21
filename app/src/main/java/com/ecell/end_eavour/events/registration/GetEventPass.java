...
public class GetEventPass extends AppCompatActivity implements PaymentResultWithDataListener {

    Button getEventPassBtn,doneBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_event_pass);

        Checkout.preload(getApplicationContext());

        getEventPassBtn = findViewById(R.id.event_pass_btn);
        doneBtn = findViewById(R.id.done_pass_btn);
        doneBtn.setVisibility(View.GONE);
        customSnacks = new CustomSnacks();

        getEventPassBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startEventPassPayment();
            }
        });
        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GetEventPass.this, Events.class);
    ...
    public void startEventPassPayment() {
        ...
        try {
            ...
            options.put("amount", "15000");//pass amount in currency subunits ( 15000 /100 )
    ...
    public void onPaymentSuccess(String s, PaymentData paymentData) {
        ...
        getEventPassBtn.setVisibility(View.GONE);
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(GetEventPass.this);
